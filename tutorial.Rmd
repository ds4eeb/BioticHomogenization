...
```{r load data}
options(timeout = 240) # set a longer download timeout in case on a slow connection
load(url("https://github.com/fishglob/FishGlob_data/raw/refs/heads/flag_hex/outputs/Cleaned_data/NEUS_std_clean.RData")) # use the branch with fixed spatial flags
#load(url("https://github.com/fishglob/FishGlob_data/raw/refs/heads/flag_hex/outputs/Cleaned_data/GMEX_std_clean.RData"))
```
...
# plot(data$longitude, data$latitude, col = is.na(data$flag_trimming_hex8_0)+1, xlab = "Longitude", ylab = "Latitude") # code to plot what will be trimmed out

# code to plot what will be trimmed out (black) or kept (red)
